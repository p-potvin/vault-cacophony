...
extern "C" {
    ...
    // arena using one I32 slot id and circular-cache head per batch item. The
    // op appends the current chunk at the head and leaves advancing that head
    // to the caller after the graph run succeeds.
